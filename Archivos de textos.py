...
archivo.write("Nota 1: Madrugar todos los días hace que tengas más tiempo para hacer las cosas .\n")
archivo.write("Nota 2: Preparar todos los deberes de la Unversidad hasta el domingo.\n")
archivo.write("Nota 3: Tener en cuenta que toca estudiar para los examenes esta semana.\n")
